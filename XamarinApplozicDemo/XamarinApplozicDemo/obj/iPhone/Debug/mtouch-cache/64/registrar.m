...
void xamarin_create_classes () {
	...
	__xamarin_class_map [15].handle = objc_getClass ("NSURLConnection");
	__xamarin_class_map [16].handle = objc_getClass ("NSURLCredential");
	__xamarin_class_map [17].handle = objc_getClass ("NSURLProtectionSpace");
	__xamarin_class_map [18].handle = objc_getClass ("NSUserDefaults");
	...
	__xamarin_class_map [42].handle = objc_getClass ("NSURLResponse");
